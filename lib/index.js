...
module.exports = function (plop) {
  ...
  plop.setHelper('camelcase', function (name) {
  ...
  plop.setGenerator('component', {
    ...
    actions: function actions(_ref) {
      ...
      if (type === _prompts.CONTAINER) {
        ...
        actions.push({
          type: 'add',
          path: "".concat(outTarget, "/{{camelcase name}}.").concat(ext),
          templateFile: (0, _helper.getContainerTemplate)(isTs, isFunction),
          data: {
        ...
        actions.push({
          type: 'add',
          path: "".concat(outTarget, "/{{camelcase name}}/index.").concat(ext),
          templateFile: (0, _helper.getTemplate)(isFunction, isTs),
          data: {
            test: isTs && options.includes('test'),
            css: options.includes('css') && !options.includes('scss') && !_helper.isReactNative
          }
        });
        ...
        if (options.includes('append')) {
          actions.push({
            // type: 'append',
            type: (0, _fs.existsSync)("".concat(outTarget, "/index.").concat(isTs ? 'ts' : 'js')) ? 'append' : 'add',
        ...
        if (options.includes('test')) {
          actions.push({
            type: 'add',
            path: "".concat(outTarget, "/{{camelcase name}}/{{camelcase name}}.spec.").concat((0, _helper.getExt)(isTs)),
        ...
        if (!_helper.isReactNative) {
          var value = options.includes('css') ? 'css' : 'scss';

          if (value === 'css') {
            actions.push({
              type: 'add',
              path: "".concat(outTarget, "/{{camelcase name}}/").concat(name.toLowerCase(), ".module.css"),
              templateFile: "".concat(__dirname, "/templates/web/style.module.hbs"),
              skip: function skip() {
                return type === _prompts.CONTAINER && _helper.isReactNative;
              }
            });
          } else {
            actions.push({
              type: 'add',
              path: "".concat(outTarget, "/{{camelcase name}}/").concat(name.toLowerCase(), ".module.scss"),
              templateFile: "".concat(__dirname, "/templates/web/style.module.hbs"),
              skip: function skip() {
                return type === _prompts.CONTAINER && _helper.isReactNative;
              }
        ...
        if (options.includes('readme')) {
          actions.push({
            type: 'add',
            path: "".concat(outTarget, "/{{camelcase name}}/Readme.md"),
        ...
        if (options.includes('story')) {
          actions.push({
            type: 'add',
            path: "".concat(outTarget, "/{{camelcase name}}/{{camelcase name}}.stories.").concat((0, _helper.getExt)(isTs)),
            templateFile: "".concat(__dirname, "/templates/stories.").concat((0, _helper.getExt)(isTs), ".hbs"),
            skip: function skip() {
              return type === _prompts.CONTAINER;
            },
            data: {
              ext: (0, _helper.getExt)(isTs)
            }
          });
        }
      }
